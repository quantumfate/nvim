...
--- Adapted from LazyVim's lib/root.lua. Callable: `require("lib.root")()` == `.get()`.
---@class lib.root
---@overload fun(): string
...
---@field spec lib.RootSpec The spec that matched

---@alias lib.RootFn fun(buf: number): (string|string[])

---@alias lib.RootSpec string|string[]|lib.RootFn
...
---@param spec lib.RootSpec
---@return lib.RootFn detector
...
--- `all` defaults to false: the common case is "which root is this buffer in", and
--- only :RootInfo wants every candidate.
---@param opts? { buf?: number, spec?: lib.RootSpec[], all?: boolean }
---@return lib.Root[] roots
function M.detect(opts)
	opts = opts or {}
	-- vim.g.root_spec overrides M.spec (set in init.lua).
	opts.spec = opts.spec or type(vim.g.root_spec) == "table" and vim.g.root_spec or M.spec
	opts.buf = (opts.buf == nil or opts.buf == 0) and vim.api.nvim_get_current_buf() or opts.buf
	local want_all = opts.all == true
