...
return {
	...
	---@field BreakpointCondition string
	---@field BreakpointData string
	---@field BreakpointFunction string
	---@field BreakpointLog string
	---@field BreakpointUnsupported string
	---@field BreakpointConditionUnverified string
	---@field BreakpointDataUnverified string
	---@field BreakpointFunctionUnverified string
	---@field BreakpointLogUnverified string
	---@field Stopped string
	---@field StepOver string
	---@field StepInto string
	---@field StepOut string
	...
	debugging = {
		...
		BreakpointConditionUnverified = " ",
		BreakpointDataUnverified = " ",
		BreakpointFunctionUnverified = " ",
		BreakpointLogUnverified = " ",
		Stopped = "󰐎 ",
		-- Control icons (from nf-cod-debug_*)
		StepOver = " ",
		StepInto = " ",
		StepOut = " ",
		Continue = " ",
